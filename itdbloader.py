...
"""
#Adding this to see if it deals with ImportError: No module named MySQLdb
#try:
#    import pymysql
...
class iTunesLoader:
  ...
  def __init__(self, config):
    ...
    self.conn = pymysql.connect(host=config.get("client", "host"),
...
if __name__ == '__main__':
  ...
  config.read(['itdb.cnf', os.path.expanduser('~/.itdb.cnf')])
