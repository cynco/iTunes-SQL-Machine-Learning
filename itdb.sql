...
Year INTEGER(2),
DATE_MODIFIED DATETIME NOT NULL DEFAULT '1000-01-01',
Date_Added datetime NOT NULL DEFAULT '1000-01-01',
Skip_Date datetime NOT NULL DEFAULT '1000-01-01',
Skip_Count INTEGER(1) DEFAULT 0,
Bit_Rate INTEGER(2),
Sample_Rate INTEGER(2),
Play_Count INTEGER(2),
Play_Date_UTC datetime NOT NULL DEFAULT '1000-01-01',
